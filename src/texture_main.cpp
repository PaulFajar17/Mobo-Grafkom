// =============================================================================
// Textures - Latihan Utama
// Menampilkan textured rectangle dengan 2 texture (container + awesomeface)
// menggunakan texture units dan mix()
// =============================================================================
...
int main() {
  ...
  // set up vertex data — positions + texture coordinates
  float vertices[] = {
