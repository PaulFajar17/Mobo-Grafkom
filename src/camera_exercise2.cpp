...
int main() {
  ...
  GLFWwindow *window = glfwCreateWindow(
      SCR_WIDTH, SCR_HEIGHT, "Camera Exercise 2 (Custom LookAt)", NULL, NULL);
  if (window == NULL) {
  ...
  Shader ourShader("src/shaders/camera.vs", "src/shaders/camera.fs");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // Using our custom lookAt function here
